...
> **Архив (21.09.2026).** План выполнен: данные из `five_verst_stats` перенесены, Grafana закрыта 04.09.2026, деплой git-based (`scripts/deploy_prod.sh`). Документ сохранён как история решений; актуальное — в [AGENTS.md](../../AGENTS.md).

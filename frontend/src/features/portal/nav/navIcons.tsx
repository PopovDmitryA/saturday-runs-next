...
// Своя (домашняя) локация: метка со звездой. Домик отдан главной сайта —
// два домика в одном «Меню» путали бы.
export const MY_PLACE_ICON = icon(
  <>
    <path d="M12 21s-7-5.6-7-11a7 7 0 0 1 14 0c0 5.4-7 11-7 11Z" />
    <path d="m12 6.8 1 2 2.2.3-1.6 1.5.4 2.2-2-1-2 1 .4-2.2-1.6-1.5 2.2-.3Z" />
  </>,
);

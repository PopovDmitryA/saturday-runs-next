    ...
    <AdminShell title="Открытия локаций">
      ...
      <section className="card">
        ...
        <p className="muted">
          ...
          открытие берётся из протокола — это событие №1. С95 номера забегов не публикует
          (у нас это порядок в хронологии), поэтому номер торжественного открытия для
          каждой площадки С95 нужно проставить руками — до этого открытий у неё нет.
        </p>
        <p className="muted">
          Пустой номер у сохранённой строки — это «открытия нет»: так гасится ложное
          открытие там, где система начала вести протоколы позже самой площадки. Кнопка
          «Снять» возвращает площадку к правилу её системы. Правка сразу пересчитывает
      ...
      <section className="card">
        ...
        <p className="muted">
          Площадок: {summary.total}. С открытием: {summary.withOpening}.

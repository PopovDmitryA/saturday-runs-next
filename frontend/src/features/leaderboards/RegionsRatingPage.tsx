...
const COUNT_HINT =
  "Считаем действующие локации: парк, который живёт сразу в двух системах, — одна " +
  "локация региона. Поэтому сумма по колонкам систем бывает больше общего числа. " +
  "Локации со статусом «не действует» в счёт не идут и показаны подписью.";

const FOREIGN_HINT =
  "Зарубежные локации считаются по странам, а не по регионам — как на карте, где " +

  ...
  return (
    <section className="card">
      ...
      <p className="muted settings-lead">
        Используется в метриках вроде «дальность стартов от дома». По умолчанию выбирается
        локация, где вы бегали чаще всего — но вы можете выбрать любую из посещённых.
      </p>

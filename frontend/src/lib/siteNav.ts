...
export const APP_NAV_ITEMS: SiteNavItem[] = [
  ...
  // Раздел открыт всем залогиненным и доступен по ссылкам с названий локаций
  // (пробежки, волонтёрство, карта). В шапку пока не выносим — до публичного
  // запуска пункт видит только админ (решение Дмитрия 13.07.2026).

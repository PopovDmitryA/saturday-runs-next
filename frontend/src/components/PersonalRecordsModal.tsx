      ...
      {!loading && !error && items.length > 0 && (
        <>
          <p className="muted personal-records-hint">
            ...
            «Дебют» — первый зачтённый старт в системе: точка отсчёта ваших результатов, поэтому
            тоже считается PR-пробежкой.
          </p>
                      ...
                      <td className="col-date">
                        ...
                        {item.is_debut && (
                          <span
                            ...
                            title="Первый зачтённый старт в этой системе — точка отсчёта ваших результатов"
                          >
                            Дебют
                          </span>
                        )}

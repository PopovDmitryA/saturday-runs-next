...
const HINTS: Record<RecordsKind, string> = {
  course:
    ...
    "показаны серым — с датой и автором перебившего результата. Зарубежный parkrun не " +
    "учитывается: его протоколы мы не собираем, и по ним рекорд трассы неизвестен.",
  age_group:

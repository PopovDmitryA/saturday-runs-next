...
Договорённости о порогах (Дмитрий, 14.09.2026; пересчитаны на час забега
18.09.2026): дождь на старте — от 0.3 мм за час забега (precipitation_run_mm),
ливень — от 3 мм; сетка Open-Meteo размазывает осадки, поэтому 0.1–0.3 мм —
«возможно, моросило», а не дождь. Считается только жидкий дождь: снегопад
дождливым стартом не считается. Мороз для челленджа «Морж» — от −20° по температуре воздуха в час
старта, жара для «Огнеупорного» — от +25°.
"""
...
# Пороги заданы на ЧАС забега, а не на четырёхчасовое окно, как раньше. Когда
# окно сузилось вчетверо, старый порог в 1 мм стал вчетверо строже: на выборке
# из 199 стартов доля дождливых падала с 6.5% до 1.5%, и «Нижний пруд
# 23.09.2023 — сильный дождь» (Наталья Волкова) уезжал в сухие при 0.7 мм за
# час. Порог 0.3 мм/ч возвращает прежнюю частоту (6.0%), но теперь дождь
# засчитывается там, где он шёл во время забега.
RAIN_MM = 0.3
DOWNPOUR_MM = 3.0
DRIZZLE_MM = 0.1
FROST_C = -10.0
DEEP_FROST_C = -20.0
# Жара одна на весь сайт: и клетка «Всепогодного», и челлендж «Огнеупорный»,
# и плитка «пробежек в жару» считают от +25° в час старта (Дмитрий, 17.09.2026).
HEAT_C = 25.0
SNOW_DEPTH_CM = 1.0
WINDY_GUST_MS = 15.0

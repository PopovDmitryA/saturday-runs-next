...
Договорённости о порогах (Дмитрий, 14.09.2026): дождь на старте — от 1 мм
(precipitation_run_mm), ливень — от 3 мм; сетка Open-Meteo размазывает осадки,
поэтому 0.3–1 мм — «возможно, моросило», а не дождь. Окно — час забега, и
только жидкий дождь: снегопад дождливым стартом не считается (18.09.2026). Мороз для челленджа «Морж» — от −20° по температуре воздуха в час

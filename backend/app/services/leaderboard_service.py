...
METRIC_META: dict[str, dict[str, str]] = {
    ...
    "wins": {
        ...
        "unit": "побед",
        "description": (
            "Победа — первое место в абсолютном зачёте пробежки. «Топ-локация "
            "побед» — локация, где участник побеждал чаще всего; число рядом — "
            "именно побед там, не всех пробежек. Дубли одной пробежки, попавшей "
            "в протоколы двух систем, не задваиваются."
        ),
    },
    "win_locations": {
...
METRIC_GENDER_DESCRIPTION: dict[str, dict[str, str]] = {
    "wins": {
        "male": (
            "Победа — первое место в мужском зачёте пробежки. «Топ-локация "
            "побед» — локация, где участник побеждал чаще всего; число рядом — "
            "именно побед там, не всех пробежек. Дубли одной пробежки, попавшей "
            "в протоколы двух систем, не задваиваются."
        ),
        "female": (
            "Победа — первое место в женском зачёте пробежки. «Топ-локация "
            "побед» — локация, где участница побеждала чаще всего; число рядом — "
            "именно побед там, не всех пробежек. Дубли одной пробежки, попавшей "
            "в протоколы двух систем, не задваиваются."
        ),
    },

...
PIPELINE_LABELS: dict[str, str] = {
    ...
    "s95 location descriptions": "s95: описания локаций",
    "s95 cancellations": "s95: отмены ближайшего старта",
...
FIELD_LABELS: dict[str, str] = {
    ...
    "candidates": "площадок без ближайшего старта",
    ...
    "protocols_updated": "протоколов обновлено",
    ...
    "description_upserted": "описание обновлено",
    "descriptions_fetched": "описаний загружено",
    "descriptions_changed": "описаний изменено",
    "descriptions_empty": "страниц без описания",
    "banned": "остановлено по бану",

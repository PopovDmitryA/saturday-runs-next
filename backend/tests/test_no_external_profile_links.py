...
# profile_url. Разрешено только там, где это привязки зарегистрированного на
# сайте человека, и в админке. Публичный профиль — осознанное исключение
# (решение Дмитрия 26.09.2026): человек сам завёл профиль на сайте и сам
# привязал эти системы. Протоколы, рейтинги, поиск и кабинет организатора
# (люди без согласия) сюда не попадают.
PLATFORM_PROFILE_URL_ALLOWED = {
    ...
    "features/public_profile/PublicProfilePage.tsx",  # бейджи систем на профиле участника сайта
}

...
def main() -> int:
    ...
    parser.add_argument("--delay-min", type=float, default=15.0, help="Min seconds between fetches (backfill)")
    parser.add_argument("--delay-max", type=float, default=30.0, help="Max seconds between fetches (backfill)")

    ...
    try:
        ...
        for raw in entries:
            ...
            if raw.get("show_on_map") and raw.get("runpark_slug"):
                ...
                matched_city = matched_location.city if matched_location else None
                matched_region = matched_location.region if matched_location else None
                if runpark_location_row is None:
                    runpark_location_row = Location(
                        ...
                        city=raw.get("city") or matched_city,
                        region=raw.get("region") or matched_region,
                    ...
                    runpark_location_row.city = raw.get("city") or runpark_location_row.city or matched_city
                    runpark_location_row.region = raw.get("region") or runpark_location_row.region or matched_region
